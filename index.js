      ...
      function searchComponent() {
        return {
          ...
          products: [
            ...
            { name: 'Tuna', url: '/pages/product.html?product=tuna-4', page: 1 },
            { name: 'Cuttle Fish', url: '/pages/product.html?product=cuttle-fish-5', page: 1 },
            { name: 'Semi Needle Loligo Squid', url: '/pages/product.html?product=semi-needle-loligo-squid-6', page: 1 },
            ...
            { name: 'Catfish (Frozen)', url: '/pages/product.html?product=catfish-frozen-9', page: 1 },
            { name: 'Queen Fish (Frozen)', url: '/pages/product.html?product=queen-fish-frozen-10', page: 1 },
            { name: 'Yellow Croaker (Frozen)', url: '/pages/product.html?product=yellow-croaker-frozen-11', page: 1 },
            { name: 'Crab', url: '/pages/product.html?product=crab-12', page: 1 },
            { name: 'Lobster (Panulirus Polyphagus)', url: '/pages/product.html?product=lobster-panulirus-polyphagus-13', page: 1 },
            { name: 'Yellowfin Tuna', url: '/pages/product.html?product=yellowfin-tuna-14', page: 1 },
            ...
            { name: 'Black Tiger Shrimp', url: '/pages/product.html?product=raw-black-tiger-shrimp-17', page: 2 },
            { name: 'Black Tiger Shrimp', url: '/pages/product.html?product=black-tiger-shrimp-peeled-18', page: 2 },
            { name: 'Black Tiger Shrimp', url: '/pages/product.html?product=black-tiger-shrimp-shellon-19', page: 2 },
            { name: 'Vannamei Shrimp', url: '/pages/product.html?product=raw-vannamei-shrimp-20', page: 2 },
            { name: 'Vannamei Shrimp', url: '/pages/product.html?product=vannamei-shrimp-pdpud-21', page: 2 },
            { name: 'Vannamei Shrimp', url: '/pages/product.html?product=vannamei-shrimp-shellon-22', page: 2 },
            ...
            { name: 'Tuna Bonito', url: '/pages/product.html?product=tuna-bonito-53', page: 3 },
            { name: 'Skip Jack', url: '/pages/product.html?product=skip-jack-54', page: 3 },
